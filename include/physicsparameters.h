...
struct PhysicsParameters
{
    ...
    float bonding_end_distance = 65.0f;     // radius to break bonding atoms
    ...
    float breaking_distance(BondDistance distance) const {
        switch(distance) {
            case BondDistance::Near: return (bonding_start_distance+bonding_end_distance)/2;
            case BondDistance::Middle: return bonding_end_distance;
            case BondDistance::Far: return bonding_end_distance;
            default: return 0;
        }
    }
